...
class ReviewRoomStoreTest(unittest.TestCase):
    ...
    def test_home_page_exposes_product_workflow_actions(self):
        ...
        self.assertIn("review_room.wait_for_action", html)
    ...
    def test_agent_invite_creates_invited_agent_member(self):
        ...
        self.assertIn("review_room.wait_for_action", invite["advanced"]["mcp"]["tools"])
        self.assertEqual(invite["advanced"]["mcp"]["actionTool"], "review_room.wait_for_action")
